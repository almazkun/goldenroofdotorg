...
class Category(models.Model):
    ...
    description = models.TextField(max_length=280, default=settings.SITE_DESCRIPTION) #SEO head meta tag Description for a category page
...
class Article(models.Model):
    ...
    img_link = models.CharField(verbose_name="Cover image", default=IMG_LINK, max_length=255)
